...
function BackgroundDecor() {
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 11, repeat: Infinity, ease: "easeInOut", delay: 0.8 }}
...
function BookshelfIllustration() {
  return (
    <svg
      ...
      aria-label="Illustration of a modern digital bookshelf"
      role="img"
...
function AnimatedIllustration() {
  return (
    <div className="relative flex items-center justify-center">
      <div aria-hidden="true" className="absolute inset-8 rounded-3xl bg-neutral-100 blur-3xl opacity-60" />
      <motion.div
        variants={fadeRight}
        initial="hidden"
        animate="show"
      ...
      <Container>
        <div className="relative grid grid-cols-1 items-center gap-16 py-28 lg:grid-cols-2 lg:gap-20 lg:py-32 xl:py-36">
          ...
          <div className="flex max-w-xl flex-col lg:max-w-none">
            ...
            {/* Headline — two lines, maximum impact */}
            <motion.h1
              id="hero-heading"
              variants={fadeUp}
              initial="hidden"
